            ...
            <form action="AccountInstellingen.php" method="GET">
                <ul>
                    <li><label for="mail">e-mailadres:</label>
                        <input type="text" id="mail" name="mail" value=<?= $data[0]; ?> readonly>
                    </li>
                    <li><label for="vnaam">Voornaam:</label>
                        <input type="text" id="vnaam" name="vnaam" value=<?= $data[1]; ?> readonly>
                    </li>
                    <li><label for="anaam">Achternaam:</label>
                        <input type="text" id="anaam" name="anaam" value=<?= $data[2]; ?> readonly>
                    </li>
                    <li><label for="land">Land:</label>
                        <input type="text" id="land" name="land" value=<?= $data[3]; ?> readonly>
                    </li>
                    <li><label for="gdatum">Geboortedatum:</label>
                        <input type="text" id="gdatum" name="gdatum" value=<?= $data[4]; ?> readonly>
                    </li>
                    <li><label for="gnaam">Gebruikersnaam:</label>
                        <input type="text" id="gnaam" name="gnaam" value=<?= $data[5]; ?> readonly>
                    </li>
                    <li><label for="ww">Wachtwoord:</label>
                        <input type="password" id="ww" name="ww" value=<?= $data[6]; ?> readonly>
                    </li>
                    <li><label for="abb">Abonnement:</label>
                        <input type="text" id="abb" name="abb" value=<?= $data[7]; ?> readonly>
                    </li>
                </ul>
